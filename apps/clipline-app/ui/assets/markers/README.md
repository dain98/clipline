...
`kill.png`, `dragon.png`, `baron.png`, and `turret.png` are **AI-generated**
silhouette icons created for Clipline's review-timeline markers. They were not
extracted, traced, or copied from any game's assets, and no third-party
copyright is claimed over them.
